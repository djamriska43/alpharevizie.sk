export const services = {
  ele: {
    ...
    list: [
      ...
      'Revízia elektrických spotrebičov podľa STN 33 1610',
      'Revízia el. ručného náradia podľa STN 33 1600',
  ...
  zdvih: {
    ...
    icon: '🏗️',
    title: 'Revízia žeriavov, výťahov, plošín a vozíkov',
    desc: 'Odborné prehliadky a skúšky zdvíhacích zariadení vrátane viazacích prostriedkov. Od žeriavov po vysokozdvižné vozíky.',
    cardDesc: 'Revízie žeriavov, výťahov, plošín, vysokozdvižných vozíkov a viazacích prostriedkov.',
    cardItems: ['Revízia žeriavu', 'Revízia výťahu', 'Revízia zdvíhacej plošiny', 'Revízia vysokozdvižného vozíka', 'Kontrola viazacích prostriedkov'],
    sectionTitle: 'Prečo sú revízie zdvíhacích zariadení také dôležité?',
    text1: 'Zdvíhacie zariadenia sú jedny z najrizikovejších technických zariadení — pracujú s ťažkými bremenami, prepravujú ľudí a akákoľvek porucha môže mať vážne následky.',
    ...
    list: [
      ...
      'Revízia osobných a nákladných výťahov',
    ...
    items: [
      ...
      { icon: '🛗', text: 'Osobný výťah', badge: 'OP 3m / OS 6r' },
