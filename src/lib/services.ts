export const services = {
  ...
  zdvih: {
    ...
    cardDesc: 'Revízie žeriavov, plošín, priemyselných brán, vysokozdvižných vozíkov a viazacích prostriedkov.',
    cardItems: ['Revízia žeriavu', 'Revízia zdvíhacej plošiny', 'Revízia priemyselných brán', 'Revízia vysokozdvižného vozíka', 'Kontrola viazacích prostriedkov'],
