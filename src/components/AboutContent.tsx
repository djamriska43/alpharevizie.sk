...
const bgNeons = ['rgba(0,212,255,0.15)','rgba(255,45,107,0.15)','rgba(139,92,246,0.15)','rgba(0,230,118,0.15)'];
...
const skills = [
  ...
  { label: 'BOZP & PO', w: '90', color: 'var(--accent)' },
    ...
    <>
      ...
      <section className="py-20 px-8 bg-[#111] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {cards.map((c, i) => (
            <Reveal key={i} delay={i * 0.1}>
              <div className="p-8 rounded-2xl border border-white/[0.08] bg-white/[0.03] hover:-translate-y-0.5 hover:bg-white/[0.05] transition-all group">
                <div className="font-mono text-5xl font-bold mb-4 transition-all" style={{color:neons[i],textShadow:`0 0 20px ${neons[i]}30`}}>{c.num}</div>
        ...
        <div className="max-w-[800px] mx-auto">
          <Reveal>
            <h2 className="text-2xl font-extrabold mb-8 text-white">Naše oprávnenia</h2>
          </Reveal>
          {skills.map((s, i) => (
