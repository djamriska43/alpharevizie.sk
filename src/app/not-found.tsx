    ...
    <section className="min-h-screen bg-[#111] flex items-center justify-center px-8">
      <div className="text-center max-w-[500px]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link href="/" className="inline-flex items-center justify-center gap-2 bg-[#00d4ff] text-black py-3 px-6 rounded-full font-bold no-underline hover:-translate-y-0.5 hover:shadow-[0_8px_30px_rgba(0,212,255,0.3)] transition-all">Domov</Link>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link href="/elektricke-zariadenia" className="text-xs text-[#00d4ff] no-underline hover:underline">Elektrické zariadenia</Link>
