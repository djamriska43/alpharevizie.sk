      ...
      <section className="py-20 px-8 bg-[#0a0a0a] border-t border-white/5">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col gap-6">
            {[
              {icon:'☎',title:'Telefón',content:'<a href="tel:+421952352669" class="text-[#00d4ff] font-semibold no-underline">+421 952 352 669</a>'},
          ...
          <Reveal direction="right">
            <form className="flex flex-col gap-4" onSubmit={(e)=>{e.preventDefault();alert('Formulár odoslaný! (demo)')}}>
              <input type="text" placeholder="Meno a priezvisko" required className="w-full py-4 px-5 border border-white/10 rounded-xl font-sans text-sm outline-none focus:border-[#00d4ff] transition-colors bg-white/[0.05] text-white placeholder-gray-500" />
              <input type="email" placeholder="E-mail" required className="w-full py-4 px-5 border border-white/10 rounded-xl font-sans text-sm outline-none focus:border-[#00d4ff] transition-colors bg-white/[0.05] text-white placeholder-gray-500" />
              <input type="tel" placeholder="Telefón" className="w-full py-4 px-5 border border-white/10 rounded-xl font-sans text-sm outline-none focus:border-[#00d4ff] transition-colors bg-white/[0.05] text-white placeholder-gray-500" />
              <select required className="w-full py-4 px-5 border border-white/10 rounded-xl font-sans text-sm outline-none focus:border-[#00d4ff] transition-colors bg-white/[0.05] text-white">
              ...
              <textarea placeholder="Opíšte nám, čo potrebujete zrevídovať..." required className="w-full py-4 px-5 border border-white/10 rounded-xl font-sans text-sm outline-none focus:border-[#00d4ff] transition-colors bg-white/[0.05] text-white placeholder-gray-500 min-h-[120px] resize-y" />
              <button type="submit" className="bg-[#00d4ff] text-black border-none py-4 px-8 rounded-full font-bold text-sm cursor-pointer font-sans hover:-translate-y-0.5 hover:shadow-[0_10px_30px_rgba(0,212,255,0.3)] transition-all">Odoslať správu →</button>
            </form>
          </Reveal>
        </div>
      </section>
