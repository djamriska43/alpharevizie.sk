...
export const metadata: Metadata = {
  title: 'Blog — Alpha Revízie',
  description: 'Odborné články o revíziách vyhradených technických zariadení. Praktické informácie a legislatívne novinky.',
};
      ...
      <div className="max-w-[1200px] mx-auto">
        <Reveal>
          <div className="flex items-center gap-3 text-gray-400 text-xs font-mono uppercase tracking-widest mb-4">
            <span className="w-5 h-[1.5px] bg-gray-300" />Blog
          </div>
          <h1 className="text-[clamp(2rem,4vw,3rem)] font-black tracking-tight mb-4">Odborné články o revíziách VTZ</h1>
          <p className="text-gray-500 text-lg leading-relaxed max-w-[600px] mb-12">Praktické informácie a rady pre prevádzkovateľov technických zariadení.</p>
        </Reveal>
